...
This image runs newman 3.4.2 on node 4.3.0 on Alpine 3.3
...
```terminal
docker pull postman/newman_alpine33:3.4.2
```
...
```
slack-to-newman[docker]

```terminal
docker run --volume="/home/postman/collections:/var/newman" -c mycollection.json.postman_collection -w https://hooks.slack.com/services/url -f config -e mycollection.json.postman_collection
```
